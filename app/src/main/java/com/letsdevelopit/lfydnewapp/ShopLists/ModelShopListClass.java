...
public class ModelShopListClass {
    ...
    public ModelShopListClass(String imagefav, String shopname, String address, String discount, String cashback, double la , double lon, double la2 , double lon2 , String a,String type,String book) {
