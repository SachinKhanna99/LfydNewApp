...
public class AdapterMyShopList extends RecyclerView.Adapter<AdapterMyShopList.Viewholder> {
    ...
    private List<ModelMyShopListClass> ModelMyShopListClass;
    private List<ModelMyShopListClass> exampleListFull;


    public AdapterMyShopList(Context context, List<ModelMyShopListClass> ModelMyShopListClass) {
        this.mcontext = context;
        this.ModelMyShopListClass = ModelMyShopListClass;
        exampleListFull = new ArrayList<>(ModelMyShopListClass);
    ...
    public void onBindViewHolder(@NonNull final Viewholder viewholder, final int i) {
        ...
        final String img = ModelMyShopListClass.get(i).getImagefav();
        final String sname = ModelMyShopListClass.get(i).getShopname();
        final String address = ModelMyShopListClass.get(i).getAddress();
        final String cashback = ModelMyShopListClass.get(i).getCashback();
        final String discount = ModelMyShopListClass.get(i).getDiscount();
        final double lat1 = ModelMyShopListClass.get(i).getLan1();
        final double lon1 = ModelMyShopListClass.get(i).getLon1();
        final double lat2 = ModelMyShopListClass.get(i).getLan2();
        final double lon2 = ModelMyShopListClass.get(i).getLon2();
        final String suid = ModelMyShopListClass.get(i).getSuid();
        final String type = ModelMyShopListClass.get(i).getType();
        final String book = ModelMyShopListClass.get(i).getBook();
    ...
    public int getItemCount() {
        return ModelMyShopListClass.size();
    }
