...
public class AdapterFavShopList extends RecyclerView.Adapter<AdapterFavShopList.Viewholder> {
    ...
    private List<ModelFavShopListClass> ModelFavShopListClass;
    private List<ModelFavShopListClass> exampleListFull;


    public AdapterFavShopList(Context context, List<ModelFavShopListClass> ModelFavShopListClass) {
        this.mcontext = context;
        this.ModelFavShopListClass = ModelFavShopListClass;
        exampleListFull = new ArrayList<>(ModelFavShopListClass);
    ...
    public void onBindViewHolder(@NonNull final Viewholder viewholder, final int i) {
        ...
        final String img = ModelFavShopListClass.get(i).getImagefav();
        final String sname = ModelFavShopListClass.get(i).getShopname();
        final String address = ModelFavShopListClass.get(i).getAddress();
        final String cashback = ModelFavShopListClass.get(i).getCashback();
        final String discount = ModelFavShopListClass.get(i).getDiscount();
        final double lat1 = ModelFavShopListClass.get(i).getLan1();
        final double lon1 = ModelFavShopListClass.get(i).getLon1();
        final double lat2 = ModelFavShopListClass.get(i).getLan2();
        final double lon2 = ModelFavShopListClass.get(i).getLon2();
        final String suid = ModelFavShopListClass.get(i).getSuid();
        final String type = ModelFavShopListClass.get(i).getType();
        final String book = ModelFavShopListClass.get(i).getBook();
        ...
        viewholder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // Log.d("msggggg", String.valueOf(lat2));
    ...
    public int getItemCount() {
        return ModelFavShopListClass.size();
    }
...
//            List<ModelFavShopListClass> filteredList = new ArrayList<>();
//
//            if (constraint == null || constraint.length() == 0) {
//                filteredList.addAll(ModelFavShopListClass);
//            } else {
//                String filterPattern = constraint.toString().toLowerCase().trim();
//
//                for (ModelFavShopListClass item : exampleListFull) {
...
//            ModelFavShopListClass.clear();
//            ModelFavShopListClass.addAll((List) results.values);
